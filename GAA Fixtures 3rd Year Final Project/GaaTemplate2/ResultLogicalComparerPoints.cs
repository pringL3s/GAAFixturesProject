...
{
    public sealed class ResultLogicalComparerPoints : IComparer
    {
        private static readonly IComparer _default = new ResultLogicalComparerPoints();
        private static readonly IComparer _defaultZeroesFirst = new ResultLogicalComparerPoints(true);
        private bool zeroesFirst = false;

        private ResultLogicalComparerPoints()
        {}

        private ResultLogicalComparerPoints(bool zeroesFirst)
        {
